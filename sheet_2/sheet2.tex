...
\begin{itemize}
    ...
    \item[ii] (Might be on next page)
        \include{ganttdiagram}
    \item[iii] % TODO: Michi
    \item[iv] % TODO: Michi? Was kann parallelisiert werden? Kann überhaupt etwas Paralellisiert werden? Oder geht's mit dem Praktikanten einfach nur schneller?
\end{itemize}
